...
/*
 * SynonymsAnswerView.java
 *
 * Created on Mar 5, 2010, 2:48:52 PM
 */
 ...
 */
public class SynonymsAnswerView extends javax.swing.JFrame {

    private Hashtable<String, ArrayList<String>> table;
    private DefaultListModel listModel;
    private String word;

    /** Creates new form SynonymsAnswerView */
    public SynonymsAnswerView(Hashtable<String, ArrayList<String>> table) {
        this.table = table;
        initComponents();
        initList();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.ben.IA.App.IAApp.class).getContext().getResourceMap(SynonymsAnswerView.class);
    ...
    private void addWordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addWordButtonActionPerformed
        ...
        AnswerDatabase.getInstance().addWord(ans);
        wordsList.setModel(listModel);
        wordsList.setSelectedIndex(i);
}//GEN-LAST:event_addWordButtonActionPerformed

    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        AnswerDatabase.getInstance().updateSynonyms(word, getArrayListOfSynonyms());
