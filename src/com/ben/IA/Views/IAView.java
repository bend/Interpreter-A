...
public class IAView extends FrameView implements Observer {
    ...
    private void append(JEditorPane convTextPane, String text) {
        if(!text.equals("\n"))
    ...
    private void initComponents() {
        ...
        convEditorPane = new javax.swing.JEditorPane();
        ...
        convEditorPane.setName("convEditorPane"); // NOI18N
    ...
    private void askTextPaneKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_askTextPaneKeyTyped
        if (evt.getKeyChar() == KeyEvent.VK_ENTER){
            append(convEditorPane, askTextPane.getText());
    ...
    private javax.swing.JEditorPane convEditorPane;
    ...
    public void update(Observable o, Object arg) {
        if(arg!=null)
            append(convEditorPane, (String) arg+"\n");
    }
